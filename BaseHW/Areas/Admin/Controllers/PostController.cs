...
namespace BaseHW.Areas.Admin.Controllers
{
    ...
    public class PostController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? page)
        {
            ...
            return View(await listOfPostVM.ToPagedListAsync(pageNumber, pageSize));
        }
        ...
        public async Task<IActionResult> Create(CreatePostVM vm)
        {
            ...
            _notification.Success("Gönderi Başarıyla Oluşturuldu");
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            if (loggedInUserRole[0] == WebsiteRoles.WebsiteAdmin || loggedInUser?.Id == post?.ApplicationUserId)
            {
                ...
                await _context.SaveChangesAsync();
                _notification.Success("Gönderi başarı ile silindi");
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            if (post == null)
            {
                _notification.Error("Gönderi bulunamadı");
                return View();
            }
            ...
            if (loggedInUserRole[0] != WebsiteRoles.WebsiteAdmin && loggedInUser!.Id != post.ApplicationUserId)
            {
                _notification.Error("Yetkili değilsiniz");
                return RedirectToAction("Index");
            }
        ...
        public async Task<IActionResult> Edit(CreatePostVM vm)
        {
            ...
            await _context.SaveChangesAsync();
            _notification.Success("Gönderi başarı ile güncellendi");
            return RedirectToAction("Index", "Post", new { area = "Admin" });
        }
